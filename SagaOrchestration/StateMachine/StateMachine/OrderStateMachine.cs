...
namespace StateMachine.StateMachine
{
    public class OrderStateMachine : MassTransitStateMachine<OrderInstance>
    {
        ...
        //public Event<OrderEvent> OrderEvent { get; set; }
        //public Event<OrderPlacedEvent> OrderPlacedEvent { get; set; }
        ...
        //public Event<StockeReservedEvent> StockeReservedEvent { get; set; }
        //public Event<StockeReserveFailedEvent> StockeReserveFailedEvent { get; set; }
        ...
        public OrderStateMachine(ILogger<OrderStateMachine> _logger)
        {

            InstanceState(x => x.CurrentState);

            Event(() => BasketCheckoutEvent, e => e.CorrelateById(m => m.Message.CorrelationId));
            //Event(() => OrderEvent, e => e.CorrelateById(m => m.Message.CorrelationId));
            //Event(() => OrderPlacedEvent, e => e.CorrelateById(m => m.Message.CorrelationId));
            ...
            //Event(() => StockeReservedEvent, e => e.CorrelateById(m => m.Message.CorrelationId));
            //Event(() => StockeReserveFailedEvent, e => e.CorrelateById(m => m.Message.CorrelationId));
            ...
            During(
                ...
                //.Publish(x =>
                //{
                //    var temp = x.Message.OrderPlacedEvent;
                //    temp.CorrelationId = x.Saga.CorrelationId;
                //    return temp;
                //})
            ...
            During(
                ...
                //.Publish(x => {
                //    return new StockeReservedEvent()
                //    {
                //        CorrelationId = x.Message.CorrelationId,
                ...
                //.Publish(x => {
                //    return new StockeReserveFailedEvent()
                //    {
                //        CorrelationId = x.Message.CorrelationId,
                //        OrderId = x.Message.orderId
                //    };
